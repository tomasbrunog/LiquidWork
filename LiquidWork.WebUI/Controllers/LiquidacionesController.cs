...
namespace LiquidWork.WebUI.Controllers
{
    public class LiquidacionesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LiquidacionId,Periodo,TotalRemunerativo,TotalNoRemunerativo,TotalDeducciones,Neto,LegajoId")] Liquidacion liquidacion)
        {
            ...
            ViewData["LegajoId"] = new SelectList(_context.Legajos, "LegajoId", "Apellido", liquidacion.LegajoId);
            return View(liquidacion);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LiquidacionId,Periodo,TotalRemunerativo,TotalNoRemunerativo,TotalDeducciones,Neto,LegajoId")] Liquidacion liquidacion)
        {
